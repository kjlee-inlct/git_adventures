...
const familyTokens=['status','diff','log','add','restore','switch','commit','revert','fetch','pull','push','stash','rebase','merge','cherry-pick','tag'];const covered=new Set(coverage.map(r=>r.command.split(/\s+/)[1]));
