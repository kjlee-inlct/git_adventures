...
export function loadContent(){
  ...
  for(const file of ['../content/missions.js','../content/missions-daily.js','../content/missions-collaboration.js']){
...
export function normalizeState(state){state.working||=[];state.staged||=[];state.commits||=[];state.stashes||=[];state.conflicts||=[];state.remote||={name:'origin',tracking:null,knownHead:null,actualHead:null,ahead:0,behind:0,fetched:false,rejected:null};if(state.remote.rejected===undefined)state.remote.rejected=null;return state;}
